...
var OnlinePaymentModel = /*#__PURE__*/ function() {
    "use strict";
    function OnlinePaymentModel() {
        _class_call_check(this, OnlinePaymentModel);
        _define_property(this, "table", 'onlinepayment');
    }
    _create_class(OnlinePaymentModel, [
        {
            key: "Knex",
            get: function get() {
        ...
        {
            key: "getOnlinePayment",
            value: function getOnlinePayment(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, onlinePayment, error;
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                if (onlinePayment == null || onlinePayment.length == 0) {
                                    ...
                                    return [
                                        2,
                                        onlinePayment // Return the first lead if found
                                    ];
                                }
                                return [
                                    3,
        ...
        {
            key: "countOnlinePayment",
            value: function countOnlinePayment(where) {
                return _async_to_generator(function() {
...
export { OnlinePaymentModel as default };
export var onlinePaymentModel = new OnlinePaymentModel();
