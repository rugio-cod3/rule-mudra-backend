...
var NoLoanFollowUpLogModel = /*#__PURE__*/ function() {
    "use strict";
    function NoLoanFollowUpLogModel() {
        _class_call_check(this, NoLoanFollowUpLogModel);
        _define_property(this, "table", 'no_loan_follow_up_logs');
    }
    _create_class(NoLoanFollowUpLogModel, [
        {
            key: "NoLoanFollowUpLogsKnex",
            get: function get() {
    ...
    return NoLoanFollowUpLogModel;
}();
export { NoLoanFollowUpLogModel as default };
export var noLoanFollowUpLogModel = new NoLoanFollowUpLogModel();

//# sourceMappingURL=noLoanFollowUpLogs.js.map