...
var StepControlModel = /*#__PURE__*/ function() {
    "use strict";
    function StepControlModel() {
        _class_call_check(this, StepControlModel);
        _define_property(this, "table", 'step_control');
    }
    _create_class(StepControlModel, [
        {
            key: "Knex",
            value: function Knex() {
    ...
    return StepControlModel;
}();
export { StepControlModel as default };
export var stepControlModel = new StepControlModel();

//# sourceMappingURL=stepControl.js.map