...
var VirtualAccountModel = /*#__PURE__*/ function() {
    "use strict";
    function VirtualAccountModel() {
        _class_call_check(this, VirtualAccountModel);
        _define_property(this, "table", 'virtualAccount');
    }
    _create_class(VirtualAccountModel, [
        {
            key: "Knex",
            get: function get() {
...
export { VirtualAccountModel as default };
export var virtualAccountModel = new VirtualAccountModel();
