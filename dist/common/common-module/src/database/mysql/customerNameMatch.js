...
var CustomerNameMatch = /*#__PURE__*/ function() {
    "use strict";
    function CustomerNameMatch() {
        var _this = this;
        var _this1 = this;
        _class_call_check(this, CustomerNameMatch);
        _define_property(this, "table", 'customer_name_match');
        _define_property(this, "findOneCustomerNameMatch", function(where) {
    ...
    _create_class(CustomerNameMatch, [
        {
            key: "find",
...
export var customerNameMatchmodel = new CustomerNameMatch();

//# sourceMappingURL=customerNameMatch.js.map