...
var RazorpayLogModel = /*#__PURE__*/ function() {
    "use strict";
    function RazorpayLogModel() {
        _class_call_check(this, RazorpayLogModel);
        _define_property(this, "table", 'razorpay_logs');
    }
    _create_class(RazorpayLogModel, [
        {
            key: "insert",
        ...
        },
        {
            ...
            value: function find(params) {
                return _async_to_generator(function() {
                    var _query, select, paginate, where, db, query;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
        ...
        },
        {
            ...
            value: function findOne(params) {
                return _async_to_generator(function() {
                    var _query, _params_select, select, where, db, query;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _params_select = params.select, select = _params_select === void 0 ? [
                                    '*'
                                ] : _params_select, where = params.where;
                                db = getKnexInstance();
                                query = db(this.table);
                                if (where) {
    ...
    return RazorpayLogModel;
}();
export { RazorpayLogModel as default };
export var razorPayLogsModel = new RazorpayLogModel();

//# sourceMappingURL=razorpayLogs.js.map