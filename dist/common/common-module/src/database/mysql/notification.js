...
var NotificationModel = /*#__PURE__*/ function() {
    ...
    function NotificationModel() {
        _class_call_check(this, NotificationModel);
        _define_property(this, "table", 'notifications');
    }
    _create_class(NotificationModel, [
        {
            key: "findOneNotification",
            value: function findOneNotification(_0) {
        ...
        },
        {
            ...
            value: // ! Remove this
            function getNotifications(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, notifications, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
        ...
        {
            key: "getNotificationsByFilter",
            value: function getNotificationsByFilter(where, order, select, page, perPage) {
                return _async_to_generator(function() {
                    var _query, db, query, key, offset, notification, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                            ...
                            case 1:
                                ...
                                if (notification == null || notification.length == 0) {
                                    ...
                                    return [
                                        2,
                                        notification // Return the first lead if found
                                    ];
                                }
                                return [
                                    3,
        ...
        },
        {
            ...
            value: function countNotifications(where) {
                return _async_to_generator(function() {
                    var db, notification, count, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db(this.table).insert(data).returning('id')
                                ];
                            case 1:
...
export { NotificationModel as default };
