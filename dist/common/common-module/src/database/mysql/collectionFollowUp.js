...
var CollectionFollowUpModel = /*#__PURE__*/ function() {
    "use strict";
    function CollectionFollowUpModel() {
        _class_call_check(this, CollectionFollowUpModel);
        _define_property(this, "table", 'collectionFollowup');
    }
    _create_class(CollectionFollowUpModel, [
        {
            key: "find",
    ...
    return CollectionFollowUpModel;
}();
export { CollectionFollowUpModel as default };
export var collectionFollowUpModel = new CollectionFollowUpModel();

//# sourceMappingURL=collectionFollowUp.js.map