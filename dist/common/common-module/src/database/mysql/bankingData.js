...
var BankingDataModel = /*#__PURE__*/ function() {
    "use strict";
    function BankingDataModel() {
        _class_call_check(this, BankingDataModel);
        _define_property(this, "table", 'bankingData');
    }
    _create_class(BankingDataModel, [
        {
            key: "insert",
        ...
        {
            key: "findOneBankingData",
            value: function findOneBankingData(params) {
                return _async_to_generator(function() {
    ...
    return BankingDataModel;
}();
export var bankingDatamodel = new BankingDataModel();

//# sourceMappingURL=bankingData.js.map