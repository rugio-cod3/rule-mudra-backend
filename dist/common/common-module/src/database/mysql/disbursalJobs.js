...
var DisbursalJobsModel = /*#__PURE__*/ function() {
    "use strict";
    function DisbursalJobsModel() {
        _class_call_check(this, DisbursalJobsModel);
        _define_property(this, "table", 'disbursal_jobs');
    }
    _create_class(DisbursalJobsModel, [
        {
            key: "DisbursalJobsKnex",
            get: function get() {
    ...
    return DisbursalJobsModel;
}();
export { DisbursalJobsModel as default };
export var disbursalJobsModel = new DisbursalJobsModel();

//# sourceMappingURL=disbursalJobs.js.map