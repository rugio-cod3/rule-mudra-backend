...
var CustomerDndModel = /*#__PURE__*/ function() {
    "use strict";
    function CustomerDndModel() {
        _class_call_check(this, CustomerDndModel);
        _define_property(this, "table", 'customer_dnd');
    }
    _create_class(CustomerDndModel, [
        {
            key: "findOne",
        ...
        {
            key: "find",
            value: function find(params, dateRange) {
                        ...
                        switch(_state.label){
                            case 0:
                                ...
                                if (dateRange && dateRange.start != null && dateRange.end != null) {
                                    query.andWhere('start_date', '>=', dateRange.start).andWhere('expiry_date', '<=', dateRange.end);
                                }
                                if (whereIn) {
    ...
    return CustomerDndModel;
}();
export { CustomerDndModel as default };
export var customerDndModel = new CustomerDndModel();

//# sourceMappingURL=customerDnd.js.map