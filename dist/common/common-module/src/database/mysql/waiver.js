...
export var WaiverModel = /*#__PURE__*/ function() {
    "use strict";
    function WaiverModel() {
        _class_call_check(this, WaiverModel);
        _define_property(this, "table", 'waiver');
    }
    _create_class(WaiverModel, [
        {
            key: "WaiverKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as w"));
            }
        },
        {
            key: "findOne",
...
export var waiverModel = new WaiverModel();
