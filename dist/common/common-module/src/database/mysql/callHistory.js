...
var CallHistoryModel = /*#__PURE__*/ function() {
    "use strict";
    function CallHistoryModel() {
        _class_call_check(this, CallHistoryModel);
        _define_property(this, "table", 'callhistory');
    }
    _create_class(CallHistoryModel, [
        {
            key: "findOneCallHistory",
            value: function findOneCallHistory(_0, _1) {
...
export var callHistorymodel = new CallHistoryModel();
