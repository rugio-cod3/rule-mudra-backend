...
var RazorpayMandateModel = /*#__PURE__*/ function() {
    "use strict";
    function RazorpayMandateModel() {
        _class_call_check(this, RazorpayMandateModel);
        _define_property(this, "table", 'razorpay_mandate');
    }
    _create_class(RazorpayMandateModel, [
        {
            key: "RpayMandateKnex",
            get: function get() {
        ...
        {
            key: "getRazorpayMandate",
            value: function getRazorpayMandate(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, razorpayMandate, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                            ...
                            case 1:
                                razorpayMandate = _state.sent();
                                if (razorpayMandate == null || (razorpayMandate === null || razorpayMandate === void 0 ? void 0 : razorpayMandate.length) == 0) {
                                    return [
                                        2,
                                        null
                                    ];
                                    ...
                                    return [
                                        2,
                                        razorpayMandate // Return the first lead if found
                                    ];
                                }
                                return [
                                    3,
                            ...
                            case 2:
                                error = _state.sent();
                                logger.error('Error Inside razorpay_mandate.ts getRazorpayMandate function', error);
                                return [
                                    3,
                                    3
                                ];
        ...
        {
            key: "getRazorpayMandateForAsferaIVR",
            value: function getRazorpayMandateForAsferaIVR(customerID, leadID) {
                return _async_to_generator(function() {
                    var db, razorpayMandate, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db(this.table).insert(_object_spread_props(_object_spread({}, data), {
        ...
        },
        {
            ...
            value: function count(params) {
                return _async_to_generator(function() {
                    var where, whereNot, whereRaw, db, count, data;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                where = params.where, whereNot = params.whereNot, whereRaw = params.whereRaw;
                                db = getKnexInstance();
                                count = db(this.table);
                                ...
                                if (whereRaw) {
                                    whereRaw.forEach(function(condition) {
                                        var rawQuery = condition.rawQuery, values = condition.values;
                                        count.whereRaw(rawQuery, values);
                                    });
                                }
                                return [
                                    4,
    ...
    return RazorpayMandateModel;
}();
export { RazorpayMandateModel as default };
export var razorpayMandateModel = new RazorpayMandateModel();

//# sourceMappingURL=razorpayMandate.js.map