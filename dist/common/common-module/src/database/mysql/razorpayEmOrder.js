...
var RazorpayEMOrderModel = /*#__PURE__*/ function() {
    "use strict";
    function RazorpayEMOrderModel() {
        _class_call_check(this, RazorpayEMOrderModel);
        _define_property(this, "table", 'razorpay_emOrder');
    }
    _create_class(RazorpayEMOrderModel, [
        {
            key: "Knex",
            get: function get() {
        ...
        {
            key: "getRazorpayEMOrder",
            value: function getRazorpayEMOrder(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, razorpayEMOrder, error;
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                if (razorpayEMOrder.length == 0) {
                                    ...
                                    return [
                                        2,
                                        razorpayEMOrder // Return the first lead if found
                                    ];
                                }
                                return [
                                    3,
        ...
        {
            key: "countRazorpayEMOrder",
            value: function countRazorpayEMOrder(where) {
                return _async_to_generator(function() {
        ...
        {
            key: "getRazorpayEMOrderAsferaIVR",
            value: function getRazorpayEMOrderAsferaIVR(customerID, leadID) {
                return _async_to_generator(function() {
                    var db, razorpayEMOrder, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                                ...
                                return [
                                    4,
                                    db("".concat(this.table, " as eord")).join('razorpay_mandate as mss', 'eord.emID', 'mss.id').join('onlinepayment as one', 'eord.orderID', 'one.razorpayOrderId').where({
                                        'eord.customerID': customerID,
                                        'eord.leadID': leadID
                                    })// .select('one.*', 'mss.*', 'eord.*')
                                    .select([
                                        'mss.inv_id',
    ...
    return RazorpayEMOrderModel;
}();
export { RazorpayEMOrderModel as default };
export var razorpayEmOrderModel = new RazorpayEMOrderModel();

//# sourceMappingURL=razorpayEmOrder.js.map