...
var SourcePartnerModel = /*#__PURE__*/ function() {
    "use strict";
    function SourcePartnerModel() {
        _class_call_check(this, SourcePartnerModel);
        _define_property(this, "table", 'source_partners');
    }
    _create_class(SourcePartnerModel, [
        {
            key: "findOne",
    ...
    return SourcePartnerModel;
}();
export { SourcePartnerModel as default };
export var sourcePartnerModel = new SourcePartnerModel();

//# sourceMappingURL=sourcePartners.js.map