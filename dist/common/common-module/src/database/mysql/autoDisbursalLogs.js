...
var AutoDisbursalLogModel = /*#__PURE__*/ function() {
    "use strict";
    function AutoDisbursalLogModel() {
        _class_call_check(this, AutoDisbursalLogModel);
        _define_property(this, "table", 'auto_disbursal_log');
    }
    _create_class(AutoDisbursalLogModel, [
        {
            key: "AutoDisbursalLogKnex",
            get: function get() {
    ...
    return AutoDisbursalLogModel;
}();
export { AutoDisbursalLogModel as default };
export var autoDisbursalLogModel = new AutoDisbursalLogModel();

//# sourceMappingURL=autoDisbursalLogs.js.map