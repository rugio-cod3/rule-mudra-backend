...
var ReferrarStepControlModel = /*#__PURE__*/ function() {
    "use strict";
    function ReferrarStepControlModel() {
        _class_call_check(this, ReferrarStepControlModel);
        _define_property(this, "table", 'referrar_step_control');
    }
    _create_class(ReferrarStepControlModel, [
        {
            key: "Knex",
            get: function get() {
        ...
        {
            key: "ReferrarStepControlKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as rsc"));
            }
        },
        {
            key: "find",
    ...
    return ReferrarStepControlModel;
}();
export { ReferrarStepControlModel as default };
export var referrarStepControlModel = new ReferrarStepControlModel();

//# sourceMappingURL=referrar_step_control.js.map