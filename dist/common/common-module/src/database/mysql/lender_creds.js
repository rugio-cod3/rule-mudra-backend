...
var LenderCredsModel = /*#__PURE__*/ function() {
    "use strict";
    function LenderCredsModel() {
        _class_call_check(this, LenderCredsModel);
        _define_property(this, "table", 'lender_creds');
    }
    _create_class(LenderCredsModel, [
        {
            key: "LenderKnex",
            get: function get() {
    ...
    return LenderCredsModel;
}();
export { LenderCredsModel as default };
export var lenderCredsModel = new LenderCredsModel();

//# sourceMappingURL=lender_creds.js.map