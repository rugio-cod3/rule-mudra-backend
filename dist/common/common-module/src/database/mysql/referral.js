...
export var ReferralModel = /*#__PURE__*/ function() {
    "use strict";
    function ReferralModel() {
        _class_call_check(this, ReferralModel);
        _define_property(this, "table", 'referral');
    }
    _create_class(ReferralModel, [
        {
            key: "ReferralKnex",
            get: function get() {
...
_define_property(ReferralModel, "instance", void 0);
