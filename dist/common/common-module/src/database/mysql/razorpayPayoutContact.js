...
var RazorPayPayoutContactsModel = /*#__PURE__*/ function() {
    "use strict";
    function RazorPayPayoutContactsModel() {
        _class_call_check(this, RazorPayPayoutContactsModel);
        _define_property(this, "table", 'razorpay_payout_contacts');
    }
    _create_class(RazorPayPayoutContactsModel, [
        {
            key: "RazorPayPayoutContactsKnex",
            get: function get() {
        ...
        {
            key: "bulkCreate",
            value: function bulkCreate(data) {
                return _async_to_generator(function() {
                    var db;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db.batchInsert(this.table, data)
                                ];
                            case 1:
                                return [
                                    2,
    ...
    return RazorPayPayoutContactsModel;
}();
export { RazorPayPayoutContactsModel as default };
export var razorPayPayoutContactsModel = new RazorPayPayoutContactsModel();

//# sourceMappingURL=razorpayPayoutContact.js.map