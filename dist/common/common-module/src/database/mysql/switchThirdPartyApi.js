...
var SwitchThirdPartyApiModel = /*#__PURE__*/ function() {
    "use strict";
    function SwitchThirdPartyApiModel() {
        _class_call_check(this, SwitchThirdPartyApiModel);
        _define_property(this, "table", 'switch_thirdparty_api');
    }
    _create_class(SwitchThirdPartyApiModel, [
        {
            key: "Knex",
            value: function Knex() {
        ...
        {
            key: "findOneStepControl",
            value: function findOneStepControl(_0, _1) {
        ...
        {
            key: "updateOneExcluding",
            value: function updateOneExcluding(where, whereNot, update) {
                return _async_to_generator(function() {
                    var db;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db(this.table).where(where).whereNot(whereNot) // Adding whereNot condition
                                    .update(update)
                                ];
                            case 1:
                                return [
    ...
    return SwitchThirdPartyApiModel;
}();
export { SwitchThirdPartyApiModel as default };
export var switchThirdPartyApiModel = new SwitchThirdPartyApiModel();

//# sourceMappingURL=switchThirdPartyApi.js.map