...
export var RewardTransactionModel = /*#__PURE__*/ function() {
    "use strict";
    function RewardTransactionModel() {
        _class_call_check(this, RewardTransactionModel);
        _define_property(this, "table", 'reward_transactions');
    }
    _create_class(RewardTransactionModel, [
        {
            key: "RewardTransactionKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as rtr"));
            }
        },
        {
            key: "Knex",
...
_define_property(RewardTransactionModel, "instance", void 0);
export var rewardTransactionModel = new RewardTransactionModel();

//# sourceMappingURL=reward_transactions.js.map