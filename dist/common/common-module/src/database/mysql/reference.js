...
var ReferenceModel = /*#__PURE__*/ function() {
    "use strict";
    function ReferenceModel() {
        _class_call_check(this, ReferenceModel);
        _define_property(this, "table", 'reference');
    }
    _create_class(ReferenceModel, [
        {
            key: "findOne",
...
export { ReferenceModel as default };
export var referenceModel = new ReferenceModel();
