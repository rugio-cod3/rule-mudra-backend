...
export var FeedbackModel = /*#__PURE__*/ function() {
    "use strict";
    function FeedbackModel() {
        _class_call_check(this, FeedbackModel);
        _define_property(this, "table", 'feedback');
    }
    _create_class(FeedbackModel, [
        {
            key: "FeedbackKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as fd"));
            }
        },
        {
            key: "findOne",
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db(this.table).where(where).count('* as count')
                                ];
                            case 1:
                                return [
                                    2,
...
export var feedbackModel = new FeedbackModel();
