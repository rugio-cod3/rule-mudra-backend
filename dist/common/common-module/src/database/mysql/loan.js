...
var LoanModel = /*#__PURE__*/ function() {
    "use strict";
    function LoanModel() {
        _class_call_check(this, LoanModel);
        _define_property(this, "table", 'loan');
    }
    _create_class(LoanModel, [
        {
            key: "LoanKnex",
            get: function get() {
        ...
        {
            key: "getLoanData",
            value: function getLoanData(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, loan, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                loan = _state.sent();
                                if (loan == null || (loan === null || loan === void 0 ? void 0 : loan.length) == 0) {
                                    return [
                                        2,
                                        null
                                    ];
                                    ...
                                    return [
                                        2,
                                        loan // Return the first loan if found
                                    ];
                                }
                                return [
                                    3,
        ...
        {
            key: "findOneLoan",
            value: function findOneLoan(_0, _1) {
        ...
        {
            key: "countLoan",
            value: function countLoan(where, whereNot) {
                return _async_to_generator(function() {
                    var db, count, data;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
...
export { LoanModel as default };
export var loanModel = new LoanModel();
