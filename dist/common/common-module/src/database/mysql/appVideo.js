...
var AppVideoModel = /*#__PURE__*/ function() {
    "use strict";
    function AppVideoModel() {
        _class_call_check(this, AppVideoModel);
        _define_property(this, "table", 'AppVedio');
    }
    _create_class(AppVideoModel, [
        {
            key: "LeadsLastUtmKnex",
            get: function get() {
...
export { AppVideoModel as default };
export var appVideoModel = new AppVideoModel();
