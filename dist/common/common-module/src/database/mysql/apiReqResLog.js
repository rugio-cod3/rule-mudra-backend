...
var ApiReqResLogModel = /*#__PURE__*/ function() {
    "use strict";
    function ApiReqResLogModel() {
        _class_call_check(this, ApiReqResLogModel);
        _define_property(this, "table", 'api_req_res_logs');
    }
    _create_class(ApiReqResLogModel, [
        {
            key: "insert",
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 2:
                                error = _state.sent();
                                logger.error('Error Inside api_req_res_log.ts findOneAndUpdate function', error);
                                return [
                                    2,
                                    0
                                ];
    ...
    return ApiReqResLogModel;
}();
export { ApiReqResLogModel as default };
export var apiReqResLogsModel = new ApiReqResLogModel();

//# sourceMappingURL=apiReqResLog.js.map