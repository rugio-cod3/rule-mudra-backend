...
var ApprovalModel = /*#__PURE__*/ function() {
    "use strict";
    function ApprovalModel() {
        _class_call_check(this, ApprovalModel);
        _define_property(this, "table", 'approval');
    }
    _create_class(ApprovalModel, [
        {
            key: "ApprovalKnex",
            get: function get() {
        ...
        {
            key: "findOneApproval",
            value: function findOneApproval(_0, _1) {
                return _async_to_generator(function(where) {
                    var select, order, _db_where, db, query;
        ...
        },
        {
            key: "getApprovals",
            value: // ! Remove this
            function getApprovals(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, approvals, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                            ...
                            case 1:
                                ...
                                if (approvals == null || approvals.length == 0) {
                                    ...
                                    return [
                                        2,
                                        approvals // Return the first lead if found
                                    ];
                                }
                                return [
                                    3,
        ...
        {
            key: "getApprovalsByFilter",
            value: function getApprovalsByFilter(where, order, select, page, perPage) {
                return _async_to_generator(function() {
                    var _query, db, query, key, offset, approvals, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
        ...
        {
            key: "countApprovals",
            value: function countApprovals(where) {
                return _async_to_generator(function() {
                    var db, approvals, count, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
        ...
        {
            key: "findOneAndUpdateApproval",
            value: function findOneAndUpdateApproval(where, update) {
                return _async_to_generator(function() {
                    var db;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
...
export { ApprovalModel as default };
export var approvalModel = new ApprovalModel();
