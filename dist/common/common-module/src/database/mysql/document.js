...
var DocumentModel = /*#__PURE__*/ function() {
    ...
    function DocumentModel() {
        _class_call_check(this, DocumentModel);
        _define_property(this, "table", 'document');
    }
    _create_class(DocumentModel, [
        {
            key: "findOne",
...
export { DocumentModel as default };
export var documentModel = new DocumentModel();
