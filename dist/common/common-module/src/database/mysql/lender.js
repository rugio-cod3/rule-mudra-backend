...
var LenderModel = /*#__PURE__*/ function() {
    "use strict";
    function LenderModel() {
        _class_call_check(this, LenderModel);
        _define_property(this, "table", 'lender');
    }
    _create_class(LenderModel, [
        {
            key: "insert",
...
export { LenderModel as default };
export var lenderModel = new LenderModel();
