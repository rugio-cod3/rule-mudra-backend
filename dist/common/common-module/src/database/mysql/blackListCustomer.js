...
var BlackListCustomerModel = /*#__PURE__*/ function() {
    "use strict";
    function BlackListCustomerModel() {
        _class_call_check(this, BlackListCustomerModel);
        _define_property(this, "table", 'blacklistCustomer');
    }
    _create_class(BlackListCustomerModel, [
        {
            key: "Knex",
            value: function Knex() {
    ...
    return BlackListCustomerModel;
}();
export { BlackListCustomerModel as default };
export var blackListCustomerModel = new BlackListCustomerModel();

//# sourceMappingURL=blackListCustomer.js.map