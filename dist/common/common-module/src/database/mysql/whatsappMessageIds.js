...
var WhatsappMessageIdsModel = /*#__PURE__*/ function() {
    "use strict";
    function WhatsappMessageIdsModel() {
        _class_call_check(this, WhatsappMessageIdsModel);
        _define_property(this, "table", 'whatsapp_message_ids');
    }
    _create_class(WhatsappMessageIdsModel, [
        {
            key: "findOneMessage",
            value: function findOneMessage(_0, _1) {
    ...
    return WhatsappMessageIdsModel;
}();
export { WhatsappMessageIdsModel as default };
export var whatsappMessageIdsModel = new WhatsappMessageIdsModel();

//# sourceMappingURL=whatsappMessageIds.js.map