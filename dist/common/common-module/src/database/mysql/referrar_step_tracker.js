...
var ReferrarStepTrackerModel = /*#__PURE__*/ function() {
    "use strict";
    function ReferrarStepTrackerModel() {
        _class_call_check(this, ReferrarStepTrackerModel);
        _define_property(this, "table", 'referrar_step_tracker');
    }
    _create_class(ReferrarStepTrackerModel, [
        {
            key: "Knex",
            get: function get() {
        ...
        {
            key: "ReferrarStepTrackerKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as rst"));
            }
        },
        {
            key: "find",
    ...
    return ReferrarStepTrackerModel;
}();
export { ReferrarStepTrackerModel as default };
export var referrarStepTrackerModel = new ReferrarStepTrackerModel();

//# sourceMappingURL=referrar_step_tracker.js.map