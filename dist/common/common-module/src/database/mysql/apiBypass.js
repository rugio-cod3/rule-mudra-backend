...
var ApiByPassModel = /*#__PURE__*/ function() {
    "use strict";
    function ApiByPassModel() {
        _class_call_check(this, ApiByPassModel);
        _define_property(this, "table", 'api_bypass');
    }
    _create_class(ApiByPassModel, [
        {
            key: "RpayMandateKnex",
            get: function get() {
    ...
    return ApiByPassModel;
}();
export { ApiByPassModel as default };
export var apiByPassModel = new ApiByPassModel();

//# sourceMappingURL=apiBypass.js.map