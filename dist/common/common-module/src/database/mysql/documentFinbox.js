...
var DocumentFinboxModel = /*#__PURE__*/ function() {
    "use strict";
    function DocumentFinboxModel() {
        _class_call_check(this, DocumentFinboxModel);
        _define_property(this, "table", 'documentFinbox');
    }
    _create_class(DocumentFinboxModel, [
        {
            key: "DocumentFinboxKnex",
            get: function get() {
        ...
        {
            key: "findOneDocumentFinbox",
            value: function findOneDocumentFinbox(_0, _1) {
    ...
    return DocumentFinboxModel;
}();
export { DocumentFinboxModel as default };
export var documentFinboxmodel = new DocumentFinboxModel();

//# sourceMappingURL=documentFinbox.js.map