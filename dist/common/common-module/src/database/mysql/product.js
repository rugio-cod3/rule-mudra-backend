...
var ProductModel = /*#__PURE__*/ function() {
    ...
    function ProductModel() {
        _class_call_check(this, ProductModel);
        _define_property(this, "table", 'products');
    }
    _create_class(ProductModel, [
        {
            key: "getProduct",
            value: function getProduct(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, product, error;
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                if (product.length == 0) {
                                    ...
                                    return [
                                        2,
                                        product // Return the first product if found
                                    ];
                                }
                                return [
                                    3,
...
export var productModel = new ProductModel();
