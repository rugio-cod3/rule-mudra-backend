...
var ChatbotStageModel = /*#__PURE__*/ function() {
    "use strict";
    function ChatbotStageModel() {
        _class_call_check(this, ChatbotStageModel);
        _define_property(this, "table", 'chatbot_stages');
    }
    _create_class(ChatbotStageModel, [
        {
            key: "ChatbotStageKnex",
            get: function get() {
    ...
    return ChatbotStageModel;
}();
export { ChatbotStageModel as default };
export var chatbotStageModel = new ChatbotStageModel();

//# sourceMappingURL=chatbotStage.js.map