...
export var ReferrarModel = /*#__PURE__*/ function() {
    "use strict";
    function ReferrarModel() {
        _class_call_check(this, ReferrarModel);
        _define_property(this, "table", 'referrar');
    }
    _create_class(ReferrarModel, [
        {
            key: "ReferrerKnex",
            get: function get() {
                var db = getKnexInstance();
                return db("".concat(this.table, " as rfr"));
            }
        },
        {
            key: "Knex",
    ...
    return ReferrarModel;
}();
_define_property(ReferrarModel, "instance", void 0);

//# sourceMappingURL=referrar.js.map