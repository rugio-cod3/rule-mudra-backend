...
var StateModel = /*#__PURE__*/ function() {
    "use strict";
    function StateModel() {
        _class_call_check(this, StateModel);
        _define_property(this, "table", 'states');
    }
    _create_class(StateModel, [
        {
            key: "StatesKnex",
            get: function get() {
        ...
        {
            key: "getStates",
            value: // Get multiple states with specific conditions
            function getStates(where, order, select) {
                return _async_to_generator(function() {
                    var _db_where, db, cities, error;
        ...
        {
            key: "findOneState",
            value: function findOneState(_0, _1) {
...
export { StateModel as default };
export var stateModel = new StateModel();
