...
var BlackListCustomerPancardModel = /*#__PURE__*/ function() {
    "use strict";
    function BlackListCustomerPancardModel() {
        _class_call_check(this, BlackListCustomerPancardModel);
        _define_property(this, "table", 'blacklistCustomerPancard');
    }
    _create_class(BlackListCustomerPancardModel, [
        {
            key: "LeadsKnex",
            get: function get() {
        ...
        {
            key: "isBlackListedCustomer",
            value: function isBlackListedCustomer(pancard) {
                return _async_to_generator(function() {
                    var isBlackListed, result;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                isBlackListed = false;
                            ...
                            case 1:
                                result = _state.sent();
                                if (result && result.status === PanCardBlackListStatus.ACTIVE) isBlackListed = true;
                                return [
                                    2,
                                    isBlackListed
                                ];
    ...
    return BlackListCustomerPancardModel;
}();
export { BlackListCustomerPancardModel as default };
export var blackListCustomerPancardModel = new BlackListCustomerPancardModel();

//# sourceMappingURL=blacklistCustomerPancard.js.map