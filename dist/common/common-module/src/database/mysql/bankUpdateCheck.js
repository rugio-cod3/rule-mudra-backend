...
var BankUpdateCheckModel = /*#__PURE__*/ function() {
    "use strict";
    function BankUpdateCheckModel() {
        _class_call_check(this, BankUpdateCheckModel);
        _define_property(this, "table", 'bank_update_check');
    }
    _create_class(BankUpdateCheckModel, [
        {
            key: "BankUpdateCheckKnex",
            get: function get() {
    ...
    return BankUpdateCheckModel;
}();
export { BankUpdateCheckModel as default };
export var bankUpdateCheckModel = new BankUpdateCheckModel();

//# sourceMappingURL=bankUpdateCheck.js.map