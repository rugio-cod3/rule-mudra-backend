...
var AddressModel = /*#__PURE__*/ function() {
    ...
    function AddressModel() {
        _class_call_check(this, AddressModel);
        _define_property(this, "table", 'address');
    }
    _create_class(AddressModel, [
        {
            key: "findOneAddress",
            value: function findOneAddress(_0, _1) {
...
export var addressModel = new AddressModel();
