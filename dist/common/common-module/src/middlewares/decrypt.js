...
var decrypt = function decrypt(req, _res, next) {
    return _async_to_generator(function() {
        var encryptionKey, encryptionIVKey, algorithm, key, IV, encryptedData, decipher, decryptedData;
            ...
            try {
                ...
                if (req.headers['x-encrypted'] === 'true') {
                    ...
                    try {
                        ...
                        logger.info('Decrypted data: ' + decryptedData + ' Endpoint: ' + req.url);
