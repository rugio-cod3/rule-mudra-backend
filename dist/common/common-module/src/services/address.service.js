...
var AddressService = /*#__PURE__*/ function() {
    ...
    function AddressService() {
        _class_call_check(this, AddressService);
        _define_property(this, "addressModel", new AddressModel());
    }
    _create_class(AddressService, [
        {
            key: "findOne",
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.addressModel.findOneAddress(where, select, order)
                                ];
                            case 1:
                                return [
                                    2,
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.addressModel.findAll(where, order, select)
                                ];
                            case 1:
                                return [
                                    2,
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    this.addressModel.findOneAndUpdate(where, update)
                                ];
                            case 1:
                                _state.sent();
                                return [
