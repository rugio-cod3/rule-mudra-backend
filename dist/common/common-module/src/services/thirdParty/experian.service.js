...
var ExperianService = /*#__PURE__*/ function(ResponseService) {
    "use strict";
    _inherits(ExperianService, ResponseService);
    function ExperianService() {
        _class_call_check(this, ExperianService);
        var _this;
        _this = _call_super(this, ExperianService, arguments), _define_property(_this, "stateModel", new StateModel()), _define_property(_this, "leadsApiLogModel", new leadsApiLogModel()), _define_property(_this, "creditReportModel", new CreditReportModel()), _define_property(_this, "apiBypassModel", new ApiBypassModel()), _define_property(_this, "razorpayClient", new razorpayClient());
        return _this;
    }
    _create_class(ExperianService, [
        {
        ...
        },
        {
            ...
            value: function getHardPullExperianBureauDetails(customerID, leadID, customerToken, userID) {
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    db('customer as c').join('leads as l', 'l.customerID', 'c.customerID').join('bureauCustomerToken as bct', 'bct.customerID', 'c.customerID').where('l.leadID', '=', leadID).where('c.customerID', '=', customerID).where('l.customerID', '=', customerID).where('bct.customerToken', '=', customerToken).whereIn('l.status', [
                                        'Fresh Lead',
                                        'Document Received'
                                    ])
                                ];
        ...
        },
        {
            ...
            value: function getExperianDetails(leadID, userID, customerID, lender_creds) {
                return _async_to_generator(function() {
                    var db, parser, customerDetails, lead, GenderCode, stateID, formattedDob, _this_convertToHardPullExperianRequest, api_request, requestData, output, environment, bypassExperianDetails, response, xmlData, _ref, savedLogId, parsedOutput;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                db = getKnexInstance();
                            ...
                            case 4:
                                bypassExperianDetails = _state.sent();
                                output = bypassExperianDetails === null || bypassExperianDetails === void 0 ? void 0 : bypassExperianDetails.api_response;
                                return [
                                    3,
                                    7
                                ];
                            ...
                            case 6:
                                ...
                                parser.parseString(xmlData, function(err, result) {
                                    ...
                                    parser.parseString(innerXml, function(innerErr, innerResult) {
                                        if (innerErr) {
                                            throw new NotFoundError('Error parsing inner XML:', {
                                                data: innerErr
                                            });
                                        }
        ...
        },
        {
            ...
            value: function convertToExperianResponse(data) {
                ...
                if (((_data_INProfileResponse = data.INProfileResponse) === null || _data_INProfileResponse === void 0 ? void 0 : (_data_INProfileResponse_UserMessage = _data_INProfileResponse.UserMessage) === null || _data_INProfileResponse_UserMessage === void 0 ? void 0 : _data_INProfileResponse_UserMessage.UserMessageText) !== 'Normal Response') {
        ...
        },
        {
            ...
            value: function convertToBureauExperianResponse(details) {
                var _details_INProfileResponse;
                var accountDetails = (details === null || details === void 0 ? void 0 : (_details_INProfileResponse = details.INProfileResponse) === null || _details_INProfileResponse === void 0 ? void 0 : _details_INProfileResponse.CAIS_Account.CAIS_Account_DETAILS) || null;
                ...
                return _object_spread_props(_object_spread({}, details), {
                    INProfileResponse: _object_spread_props(_object_spread({}, details.INProfileResponse), {
                        CreditProfileHeader: {},
                        CAIS_Account: _object_spread_props(_object_spread({}, details.INProfileResponse.CAIS_Account), {
...
//# sourceMappingURL=experian.service.js.map