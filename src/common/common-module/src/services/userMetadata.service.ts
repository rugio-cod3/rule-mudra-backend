...
class UserMetaDataService {
  ...
  public async findOne(
    ...
    try {
      let metadata = await this.userMetaDataModel.getUserMetaData(where, order, select)
      if (metadata == null) {
        return null
      } else {
  ...
  public async find(
    ...
    try {
      let metadata = await this.userMetaDataModel.getUserMetaDatas(where, order, select)
